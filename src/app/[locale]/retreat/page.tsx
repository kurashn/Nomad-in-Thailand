...
export default function RetreatPage() {
    ...
    return (
        <div className="min-h-screen bg-[#020B18] text-white font-sans overflow-x-hidden">
            {/* 1. Hero Section */}
            <section className="relative min-h-[90vh] flex flex-col justify-center px-6 pt-24 pb-20">
                <div className="absolute inset-0 z-0">
                    <Image
                        ...
                        priority
                    />
                    <div className="absolute inset-0 bg-gradient-to-b from-[#020B18]/60 via-[#020B18]/40 to-[#020B18]" />
                    <div className="absolute inset-0 bg-gradient-to-r from-[#020B18]/80 to-transparent" />
                </div>

                <div className="max-w-6xl mx-auto relative z-10 w-full mt-10">
                    <motion.div initial="hidden" animate="visible" variants={fadeIn}>
                        <h2 className="text-[#E5B55C] font-bold tracking-widest text-sm md:text-base mb-4 drop-shadow-md">
                            2泊3日ウェルネス・リトリート合宿
                        </h2>
                        ...
                        <p className="text-xl md:text-2xl font-medium mb-12 drop-shadow-md">
                            チェンマイで、心と体をリセットする3日間。
                        </p>

                        <div className="flex flex-wrap gap-4 mb-12">
                            <div className="flex items-center gap-3 bg-black/40 backdrop-blur-md border border-[#E5B55C]/30 px-5 py-3 rounded-xl text-sm md:text-base text-[#E5B55C]">
                                <Calendar className="w-5 h-5" />
                                <div>
                                    <div className="font-bold">2026年</div>
                                    <div className="text-xs">6〜8月ごろ開催予定（調整中）</div>
                                </div>
                            </div>
                            <div className="flex items-center gap-3 bg-black/40 backdrop-blur-md border border-[#E5B55C]/30 px-5 py-3 rounded-xl text-sm md:text-base text-[#E5B55C]">
                                <MapPin className="w-5 h-5" />
                                <div>
                                    <div className="font-bold">タイ・チェンマイ</div>
                                    <div className="text-xs">大自然の中のヴィラ</div>
                                </div>
                            </div>
                            <div className="flex items-center gap-3 bg-black/40 backdrop-blur-md border border-[#E5B55C]/30 px-5 py-3 rounded-xl text-sm md:text-base text-[#E5B55C]">
                                <Users className="w-5 h-5" />
                                <div>
                                    <div className="font-bold">少人数限定</div>
                                    <div className="text-xs">安心のコミュニティ</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-start gap-4">
                            <a
                                ...
                                className="group flex items-center justify-center gap-4 w-full md:w-auto min-w-[320px] bg-[#00A37E] hover:bg-[#008c6a] text-white px-8 py-5 rounded-full font-bold text-lg transition-all duration-300 shadow-[0_0_20px_rgba(0,163,126,0.4)] hover:shadow-[0_0_30px_rgba(0,163,126,0.6)] hover:-translate-y-1"
                            >
                                <span>先行案内を受け取る</span>
                                <div className="w-8 h-8 shrink-0 rounded-full border border-white/40 flex items-center justify-center group-hover:bg-white group-hover:text-[#00A37E] transition-colors">
                                    <ChevronRight className="w-5 h-5" />
                                </div>
                            </a>
                            <p className="text-sm text-white/70 ml-4 font-medium">公式LINEで最新情報をお届けします</p>
                        </div>
                    </motion.div>
                </div>
            </section>
