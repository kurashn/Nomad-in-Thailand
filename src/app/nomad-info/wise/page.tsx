...
import { ArrowLeft, Check, X, ArrowRight, ExternalLink, Globe, CreditCard, Clock, ShieldCheck } from "lucide-react";
...
export default function WiseGuidePage() {
    ...
    const jsonLd = {
        ...
        "@type": "Article",
        "headline": "海外送金「Wise」完全ガイド。なぜノマドの必須ツールなのか？",
        "image": "https://nomad-th.com/images/wise_hero_v2.png",
        ...
        "description": "海外送金の常識が変わる。銀行の最大8倍安く、圧倒的に速い「Wise」の仕組みとメリットを徹底解説。"
    };
    ...
    const faqJsonLd = {
        ...
        "mainEntity": [
            {
                "@type": "Question",
                "name": "Wiseの手数料は本当に安いですか？",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "はい、一般的な日本の銀行と比較して最大8倍安くなる場合があります。隠れコスト（為替手数料）がないため、実際の受取額が多くなります。"
                }
            },
            {
                "@type": "Question",
                "name": "Wiseは安全ですか？日本の法律で認可されていますか？",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "はい、Wiseは関東財務局に「資金移動業者（第00040号）」として登録されており、日本の法令に基づき顧客資産は100%保全されています。"
                }
            },
            {
                "@type": "Question",
                "name": "アカウント作成には何が必要ですか？",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "スマートフォンと、本人確認書類（マイナンバーカード、運転免許証など）があれば、オンラインで完結します。"
                }
            }
        ]
    };
    ...
    return (
        <article className="min-h-screen bg-slate-50 pb-20 font-sans text-slate-800">
            ...
            {/* Standard Hero Header (Matching Cafe Guide) */}
            ...
            <div className="container max-w-3xl mx-auto px-4 mt-12">
                ...
                {/* Introduction / Hook (Refined for readability) */}
